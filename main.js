...
var author$project$Main$locationListDecoder = A2(
	...
	'locations',
	elm$json$Json$Decode$list(author$project$Main$locationDecoder));
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			...
			return _Utils_Tuple2(
				author$project$Main$Success(locations),
...
var author$project$Main$locationToHtml = function (loc) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('loc-row')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('loc-cell-img')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								A2(elm$html$Html$Attributes$attribute, 'src', loc.imgurl)
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('loc-cell-name')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(loc.name)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('loc-cell-pressure')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromFloat(loc.pressure))
					]))
			]));
};
		...
		default:
			...
			return A2(
				...
				A2(
					...
					_List_fromArray(
						[author$project$Main$locationHeaders]),
					A2(elm$core$List$map, author$project$Main$locationToHtml, locations)));
	}
};
